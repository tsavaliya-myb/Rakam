...
export class ListSalesBillsDto {
  @ApiPropertyOptional({ description: 'Filter by bill type tab', enum: ['all', 'TAX_INVOICE', 'JOB_CHALLAN'] })
  @IsOptional()
  @IsEnum(['all', 'TAX_INVOICE', 'JOB_CHALLAN'])
  tab?: 'all' | BillType;
